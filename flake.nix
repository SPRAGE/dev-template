        ...
        apps.fresh-start =
          let
            ...
            script = pkgs.writeShellScriptBin "fresh-start" ''
              ...
              echo "fresh-start: This will REMOVE ALL shared AI, Codex, and Claude Code configuration and re-sync from template."
              echo ""
              echo "  Targets:"
          ...
          in
          {
            ...
            meta = {
              description = "Reset AI.md, managed adapters, shared AI context, shared skills, Codex repo skills/config/custom agents, and Claude config in a project and restore dev-template defaults";
            };
          };
